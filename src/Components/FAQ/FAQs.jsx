  ...
  return (
    <div className="relative py-28 dark:bg-[#111928] dark:text-white">
      ...
      <div className=" flex flex-col items-center justify-center gap-4">
        <p className="font-medium tracking-wide text-[#3758f9]">FAQ</p>
      ...
      {/* descriptions start */}
      <div className=" px-0 mt-20 flex sm:flex-col md:flex-row flex-wrap justify-center items-center gap-12">
        <div className="w-[80%] md:w-[40%] lg:w-[45%] flex justify-center items-start gap-5">
